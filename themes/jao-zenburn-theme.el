...
(zenburn-with-color-variables
  (let ((f (jao-themes-parse-faces
            `((circe-my-message-face (c "gray70"))
              ...
              ;; (mode-line (c ,zenburn-fg ,zenburn-bg-2))
              (mode-line (c ,zenburn-fg ,zenburn-bg-05))
              (mode-line-inactive (~ header-line))
              (powerline-active1 (c nil ,zenburn-bg-05))
              (powerline-active2 (c nil ,zenburn-bg-1))
              (spaceline-read-only (c nil ,zenburn-blue-3))
